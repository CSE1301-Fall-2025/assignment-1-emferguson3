...
`   while(sticks>0){
    ...
    if(take <= 2 || take >= 1){
        System.out.println("Round "+counter+": "+sticks+" at start human takes "+take+" , so "+(sticks-take)+" remain");
        sticks = sticks -take;
    } else {
    ...
    System.out.println("Round "+counter+": "+sticks+" at start computer takes "+random+" , so "+(sticks-random)+" remain");
